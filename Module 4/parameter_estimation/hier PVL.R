...
#load control data
ctr_data <- read.table("Module 4/data/IGTdata_healthy_control.txt",header=TRUE)
...
samples <- jags.parallel(data, inits=NULL, params,
                model.file ="Module 4/parameter_estimation/hier_PVL.txt",
                n.chains=3, n.iter=5000, n.burnin=1000, n.thin=1, n.cluster=4)
...
###########################################################
#---------- run the hierarchical model on controls ORL --------
###########################################################
