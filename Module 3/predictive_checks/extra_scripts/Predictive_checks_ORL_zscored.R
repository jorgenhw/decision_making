...
# z-scoring the payoffs (to assess the effect of the different kinds of scaling)
X_all <- (X_all-mean(X_all, na.rm=TRUE))/sd(X_all, na.rm=TRUE)
...
temp_samples <- jags(data, inits=NULL, params,
                model.file ="216377/Module3/ORL.txt",
